    ...
    <>
      <div className="tm-section-wrap">
        ...
        <section id="home" className="tm-section">
          <h2 className="tm-text-primary">Добре дошли в ЗдравоЗемя</h2>
          <hr className="mb-5" />
          <div className="row">
            <div className="col-lg-6 tm-col-home mb-4">
              <div className="tm-text-container">
                ...
                <p>
                  Добре дошли в ЗдравоЗемя – твоят свят на забавление, здраве и
            ...
            <div className="col-lg-6 tm-col-home mb-4">
              <div className="tm-text-container">
                ...
                <p>
                  ЗдравоЗемя е по-забавна с приятели! Създайте отбори,
